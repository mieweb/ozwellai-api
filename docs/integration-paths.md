...
description: Choose the right integration approach for your use case - widget, custom UI, or backend API
---
...
➡️ [Backend API Documentation](./backend/overview.md)
...
➡️ [Complete CDN Documentation](./frontend/cdn-embed.md)
...
➡️ [Backend API Reference](./backend/api-overview.md)
...
- 📱 **[Frontend Integration](./frontend/overview.md)** - Add Ozwell's widget to your site
- ⚙️ **[Backend Integration](./backend/overview.md)** - Programmatic API access
