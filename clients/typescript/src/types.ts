...
/**
 * Streaming chunk from chat completion API calls.
 * Sent as Server-Sent Events (SSE) when stream parameter is true.
 */
export interface ChatCompletionChunk {
  ...
  choices: Array<{
    ...
    delta: {
      /** The role of the author of this message (only in first chunk) */
      role?: 'assistant';
